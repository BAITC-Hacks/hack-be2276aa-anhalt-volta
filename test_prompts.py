...
@pytest.mark.parametrize('text,expected', [
    ...
    ('Покажи баланс и поменяй адрес.', 'check_balance'),
...
def test_live_validates_response_and_passes_history(monkeypatch):
    ...
    invalid = route('Да', mode='live')
    assert invalid['fallback_reason'] == 'INVALID_ROUTER_OUTPUT'
    assert invalid['execution_status'] == 'clarification'
